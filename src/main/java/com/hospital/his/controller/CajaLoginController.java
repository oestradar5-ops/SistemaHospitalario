...
@Controller
public class CajaLoginController {

    private final UsuarioRepository usuarioRepository;


    public CajaLoginController(
    ...
    // =====================================================
    // MOSTRAR LOGIN DE CAJA
    // =====================================================

    @GetMapping("/caja/login")
    ...
    public LoginResponse iniciarSesion(
        ...
        if (!"CAJERO".equalsIgnoreCase(
                usuario.getRol())) {

            return new LoginResponse(
                    "ROL_NO_AUTORIZADO",
                    "Este acceso es exclusivo para caja.",
                    usuario.getRol()
            );
        }
